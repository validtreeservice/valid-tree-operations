...
export default function AppShell() {
  ...
  return <div className="app-shell"><aside className={open ? 'sidebar open' : 'sidebar'}>
    ...
    <div className="sidebar-foot"><span className={isDemo ? 'mode demo' : 'mode'}>{isDemo ? 'Demo workspace' : 'Live workspace'} · v2.6.0</span><button onClick={signOut}>Sign out</button></div>
